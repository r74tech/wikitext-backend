...
import {
    ...
    renderFtml,
    renderText,
} from "./controllers/v1/ftmlController";
...
app.get("/", async (c) => {
    return c.json({
        ...
        endpoints: {
            ...
            ftml: {
                parse: "/v1/ftml/parse",
                render: "/v1/ftml/render",
                detailRender: "/v1/ftml/detail-render",
                renderText: "/v1/ftml/render-text",
                wordCount: "/v1/ftml/word-count",
            },
        },
    });
});
...
app.post("/v1/ftml/parse", parseFtml);
app.post("/v1/ftml/render", renderFtml);
app.post("/v1/ftml/detail-render", detailRenderFtml);
app.post("/v1/ftml/render-text", renderText);
app.post("/v1/ftml/word-count", getWordCount);
