...
export async function up(db: Kysely<unknown>): Promise<void> {
  // Add Wikidot integration columns to indexdata
  await db.schema
  ...
  // Add Wikidot tracking to revisiondata
  await db.schema
    .alterTable('revisiondata')
    .addColumn('wikidotRevisionId', 'text')
    .execute();

  // Create wikidot_sync_log table
  await db.schema
